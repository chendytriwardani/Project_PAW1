                ...
                <div class="col-md-6 justify-content-center text-center">
                  <div class="card ms-5 " style="width: 18rem;">
                    ...
                    <div class="card-body">
                      ...
                      <a href="updateeko.php" class="btn btn-warning">Edit</a>
                      <a href="editeko.php" class="btn btn-warning">Tambah</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 justify-content-center" >
                  <div class="card ms-5 " style="width: 18rem;">
                    ...
                    <div class="card-body text-center">
                      ...
                      <a href="updateeks.php" class="btn btn-warning">Edit</a>
                      <a href="editeks.php" class="btn btn-warning">Tambah</a>
                    </div>
                  </div>
          </div><br>
      </div>
